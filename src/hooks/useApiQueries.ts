...
export function useDeviceLogs(params?: { page?: number; limit?: number; searchKey?: string; surveyId?: string; mintues?: number; }) {
  ...
  }, [params?.page, params?.limit, params?.searchKey, params?.surveyId, params?.mintues, currentSurvey?.id]);
